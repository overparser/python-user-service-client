...
from pydantic import BaseModel, StrictInt, StrictStr, conlist, constr, validator
...
class PatchUsersUserIdRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchUsersUserIdRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchUsersUserIdRequest:
        """Create an instance of PatchUsersUserIdRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchUsersUserIdRequest.parse_obj(obj)

        _obj = PatchUsersUserIdRequest.parse_obj({
