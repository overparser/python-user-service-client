...
from pydantic import BaseModel, StrictStr, conint, conlist, constr, validator
from openapi_client.models.user_preferences import UserPreferences

class User(BaseModel):
    """
    User model  # noqa: E501
    """
    user_id: Optional[StrictStr] = None
    telegram_login: Optional[StrictStr] = None
    telegram_id: Optional[conint(strict=True, ge=0)] = None
    ...
    __properties = ["user_id", "telegram_login", "telegram_id", "registration_date", "username", "status", "last_updated", "default_repeats", "preferences"]
